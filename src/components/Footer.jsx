...
const Footer = () => {
  return (
    <footer className="bg-[#2bb2ed] pt-[48px] pb-[32px] block mt-[50px]">
      <div className="max-w-[1020px] mx-auto">
        <div className="flex flex-row flex-wrap h-[100px] bg-[#54c1f0] justify-between">
        ...
        <div className="flex flex-row flex-wrap md:mt-[60px] mt-5">
